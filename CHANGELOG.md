...
* Docker support covers headless execution and tmux Pattern A attach behavior. Pattern D, Pattern E, Kubernetes, SandboxClaim, injected sidecars, reconnecting PTY, credential volume management, first class firewall UX, privileged execution, and aggressive capability hardening remain out of scope.
